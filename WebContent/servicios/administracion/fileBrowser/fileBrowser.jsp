...
<s:url id="root" value="/" />
<a href="${root}">Return to the application</a>
...
<link rel="stylesheet" type="text/css" href="<%=CSS_NAME%>">
	...
	<style type="text/css">
		input.button {background-color: #c0c0c0; color: #444;
		border: 1px solid #939A3C; margin: 5px 1px 5px 1px;}
		input.textfield {border: 1px solid #939A3C; margin: 5px 1px 5px 1px;}
		input.button:Hover { color: #000; border: 1px solid #444; }
		table.filelist {background-color:#666666; width:100%; border:0px none #ffffff}
		.formular {margin: 1px; background-color:#ffffff; padding: 1em; border:1px solid #444;}
		.formular2 {margin: 1px;}
		th { background-color:#f0f3C9 }
		tr.mouseout { background-color:#ffffff; }
		tr.mousein  { background-color:#E0E3C9; }
		tr.checked  { background-color:#eaeaea }
		tr.mousechecked { background-color:#d8E1C7 }
		td { font-family:Verdana, Arial, Helvetica, sans-serif; font-size: 8pt; color: #666666;}
		td.message { background-color: #98A24D; color: #ffffff; text-align:center; font-weight:bold}
		td.error { background-color: #ee5500; color: #ffffff; text-align:center; font-weight:bold}
		A { color:#BD4F21; text-decoration: none; }
		A:Hover { color : #7C8634; text-decoration : underline; }
		BODY { font-family:Verdana, Arial, Helvetica, sans-serif; font-size: 8pt; color: #666666; background-color: #f3f3f3;}
	</style>
	<%}
